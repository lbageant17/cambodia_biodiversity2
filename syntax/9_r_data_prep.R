...
ccm_traits <- t %>% 
  ...
  # collapse ccm_traits data to species level. This is later used in body size analysis.
...
# Combine species-level traits, ccm and relative abundance data
  ccm_traits_specieslevel <- full_join(ccm_traits_specieslevel, scode, by = "scode_ccm")
#  ccm_traits_specieslevel <- full_join(ccm_traits_specieslevel, by = "scode_ccm")
