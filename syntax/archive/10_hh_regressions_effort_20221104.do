...
* These regressions will be calculated with robust SEs and output
	...
	* add effort
	reg catch_species cfr_species $effort, vce(cluster cfrid)
	est sto effort
	post `betas' ("catch_species") ("cfr_species") ("effort") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species")  ("")
	post `betas' ("catch_species") ("cfr_species") ("effort") (_b[effort]) (_se[effort]) ("effort") ("")

	* add hh characteristics
	reg catch_species cfr_species $effort $hh, vce(cluster cfrid)
	est sto hh 
	post `betas' ("catch_species") ("cfr_species") ("hh") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species")  ("")
	post `betas' ("catch_species") ("cfr_species") ("hh") (_b[effort]) (_se[effort]) ("effort")  ("")
	
	* add market access
	reg catch_species cfr_species $effort $hh $mkt, vce(cluster cfrid) 
	est sto mkt 
	post `betas' ("catch_species") ("cfr_species") ("mkt") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("catch_species") ("cfr_species") ("mkt") (_b[effort]) (_se[effort]) ("effort")  ("")
		
	* interact market access
	reg catch_species c.cfr_species##c.city_distance $effort $hh, vce(cluster cfrid) 
	est sto mktx 
...
** Set up Wald test of equality across model coefficients
	...
	* These are same regressions as above, but used for suest test so robust SEs are included there and not in main regs.
	...
	est sto base 
	* add effort
	reg catch_species cfr_species $effort
	est sto effort
	* add hh characteristics
	reg catch_species cfr_species $effort $hh
	est sto hh 
	* add market access
	reg catch_species cfr_species $effort $hh $mkt 
	est sto mkt 
	* interact market access
	reg catch_species c.cfr_species##c.city_distance $effort $hh 
	est sto mktx 
	
	suest base effort hh mkt mktx, vce(cluster cfrid)

	test [base_mean]cfr_species = [effort_mean]cfr_species 
	post `wald' ("Catch diversity") ("System diversity") ("Base = Effort ") (r(p)) ("")
	
	test [effort_mean]cfr_species = [hh_mean]cfr_species
...
* These regressions will be calculated with robust SEs and output
	...
	* interact market access
	...
	outreg2 [base effort hh mkt mktx] using "$output/$date/tables/hh_regs_effort/species_catch_x_consumption", replace excel label ///
...
* These regressions will be calculated with robust SEs and output
	...
	* interact market access
	...
	outreg2 [base effort hh mkt mktx] using "$output/$date/tables/hh_regs_effort/species_catch_x_sold", replace excel label ///
...
* These regressions will be calculated with robust SEs and output
	...
	est sto base 
	post `betas' ("consumption_species") ("cfr_species") ("base") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	* add effort
	reg consumption_species cfr_species $effort, vce(cluster cfrid)
	post `betas' ("consumption_species") ("cfr_species") ("effort") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("consumption_species") ("cfr_species") ("effort") (_b[effort]) (_se[effort]) ("effort") ("")
	est sto effort
	* add hh characteristics
	reg consumption_species cfr_species $effort $hh, vce(cluster cfrid)
	est sto hh 
	post `betas' ("consumption_species") ("cfr_species") ("hh") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("consumption_species") ("cfr_species") ("hh") (_b[effort]) (_se[effort]) ("effort") ("")

	* add market access
	reg consumption_species cfr_species $effort $hh $mkt, vce(cluster cfrid)
	est sto mkt 
	post `betas' ("consumption_species") ("cfr_species") ("mkt") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("consumption_species") ("cfr_species") ("mkt") (_b[effort]) (_se[effort]) ("effort") ("")
	* interact market access
	reg consumption_species c.cfr_species##c.city_distance $effort $hh, vce(cluster cfrid) 
	est sto mktx 
	
	outreg2 [base effort hh mkt mktx] using "$output/$date/tables/hh_regs_effort/species_system_x_cons", replace excel label ///
...
** Set up Wald test of equality across model coefficients
	...
	* These are same regressions as above, but used for suest test so robust SEs are included there and not in main regs.		
	...
	est sto base 
	* add effort
	reg consumption_species cfr_species $effort
	est sto effort
	* add hh characteristics
	reg consumption_species cfr_species $effort $hh
	est sto hh 
	* add market access
	reg consumption_species cfr_species $effort $hh $mkt
	est sto mkt 
	* interact market access
	reg consumption_species c.cfr_species##c.city_distance $effort $hh 
	est sto mktx 
...
* These regressions will be calculated with robust SEs and output
	...
	est sto base 
	post `betas' ("sold_species") ("cfr_species") ("base") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	*add effort
	reg sold_species cfr_species $effort
	est sto effort
	post `betas' ("sold_species") ("cfr_species") ("effort") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("sold_species") ("cfr_species") ("effort") (_b[effort]) (_se[effort]) ("effort") ("")
	* add hh characteristics
	reg sold_species cfr_species $effort $hh, vce(cluster cfrid)
	est sto hh 
	post `betas' ("sold_species") ("cfr_species") ("hh") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("sold_species") ("cfr_species") ("hh") (_b[effort]) (_se[effort]) ("effort") ("")
	* add market access
	reg sold_species cfr_species $effort $hh $mkt, vce(cluster cfrid)
	est sto mkt 
	post `betas' ("sold_species") ("cfr_species") ("mkt") (_b[cfr_species]) (_se[cfr_species]) ("cfr_species") ("")
	post `betas' ("sold_species") ("cfr_species") ("mkt") (_b[effort]) (_se[effort]) ("effort") ("")
	* interact market access
	reg sold_species c.cfr_species##c.city_distance $effort $hh, vce(cluster cfrid)
	est sto mktx 
	
	outreg2 [base hh mkt mktx] using "$output/$date/tables/hh_regs_effort/species_system_x_sold", replace excel label ///
...
** Set up Wald test of equality across model coefficients
	...
	* add effort
	...
	est sto effort
	* add hh characteristics
	reg sold_species cfr_species $effort $hh
	est sto hh 
	* add market access
	reg sold_species cfr_species $effort $hh $mkt
	est sto mkt 
	* interact market access
	reg sold_species c.cfr_species##c.city_distance $effort $hh
	est sto mktx 
...
export excel using "$output/$date/tables/hh_regs_effort/wald_tests.xlsx", sheet("Species count models") sheetmodify firstrow(variables)
...
export excel using "$output/$date/tables/hh_regs_effort/betas.xlsx", sheet("Species count models") sheetmodify firstrow(variables)
